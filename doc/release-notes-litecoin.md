Graviocoin Core version 0.13.3 is now available from:
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/graviocoin-project/graviocoin/blob/0.13/src/chainparams.cpp#L214).
